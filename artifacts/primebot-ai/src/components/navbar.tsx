    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        >
          ...
          />
          <span className="hidden text-xl font-display font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-white/70">
            PrimeBot <span className="text-primary">AI</span>
          </span>
        </a>
